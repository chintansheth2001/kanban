  ...
  switch (action.type) {
    ...
    case CHANGE_ACTIVE_PROJECT: {
      const nextState = produce(state, (draft) => {
        draft.projects.map((i) =>
          action.payload === i.id ? (i.active = true) : (i.active = false)
        );
      });
      return { ...nextState };
    }
